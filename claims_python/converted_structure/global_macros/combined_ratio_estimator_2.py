...
Source: Global Macros/combined ratio estimator 2.sas
"""
...
def combined_ratio_estimator2(*args: Any, **kwargs: Any):
    """Converted entrypoint for SAS macro %combined_ratio_estimator2."""
    _arguments = {
        "args": args,
        "kwargs": kwargs,
    }
    _sas_block = """				proc means data=all noprint;
				...
				*if &contractor_cluster=" " then &contractor_cluster="zall";
				...
				set results;
				run;"""
    return run_transpiled_macro(source_file="Global Macros/combined ratio estimator 2.sas", macro_name="combined_ratio_estimator2", arguments=_arguments, sas_block=_sas_block)
