...
Source: Global Macros/raterun_Stage1 level and national overall.sas
"""
...
def raterun2(*args: Any, **kwargs: Any):
    """Converted entrypoint for SAS macro %raterun2."""
    _arguments = {
        "args": args,
        "kwargs": kwargs,
    }
    _sas_block = """		%let contractor_cluster=state;
		%let strata=strata;
...
run;"""
    return run_transpiled_macro(source_file="Global Macros/raterun_Stage1 level and national overall.sas", macro_name="raterun2", arguments=_arguments, sas_block=_sas_block)
