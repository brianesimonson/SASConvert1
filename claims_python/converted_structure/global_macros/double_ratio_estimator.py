...
Source: Global Macros/double_ratio_estimator.sas
"""
...
def double_ratio_estimator(*args: Any, **kwargs: Any):
    """Converted entrypoint for SAS macro %double_ratio_estimator."""
    _arguments = {
        "args": args,
        "kwargs": kwargs,
    }
    _sas_block = """data weights2;
set weights2;
...
run;
				...
				set results;
				run;"""
    return run_transpiled_macro(source_file="Global Macros/double_ratio_estimator.sas", macro_name="double_ratio_estimator", arguments=_arguments, sas_block=_sas_block)
